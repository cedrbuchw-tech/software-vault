...
/**
 * Render a dialog straight into <body>.
 *
 ...
 * the containing block instead. Party mode animates a `filter` on the page
 * root, which is exactly why dialogs slid down while it was on. Escaping to
 * <body> makes them immune to whatever the page is doing.
 */
